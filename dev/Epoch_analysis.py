...
def evaluate_epochs(model, X, lr, n_epochs, label, edge_index=None, edge_weight=None, batch_size=None):
    rng_seed = 0
...
def main():
    ...
    torch.save(model_dict, root_dir + f'/outputs/Optuna_analysis/model_dict_{dataset_name}.pkl')
