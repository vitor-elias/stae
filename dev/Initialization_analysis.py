...
def main():
    ...
    for model_name in model_names:  
        ...
        for idx, dataset in enumerate(datasets, start=1):
            ...
            f1_dataset.append(f1_seed)
            mcc_dataset.append(mcc_seed)

        initialization_results[model_name] = {
            'auc': auc_dataset,
            'f1': f1_dataset,
            'mcc': mcc_dataset
        }
    ...
    torch.save(initialization_results, root_dir + f'/outputs/Optuna_analysis/initialization_{dataset_name}.pkl')
